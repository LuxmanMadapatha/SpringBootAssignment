...
public ResponseEntity<Transaction> deposit(@RequestBody BankAccount bankaccount, @PathVariable("amount") float amount) {
...
public ResponseEntity<Transaction> withdraw(@RequestBody BankAccount bankaccount, @PathVariable("amount") float amount) {
